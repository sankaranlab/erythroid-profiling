...
order_pub <- c("PB.PB_CD34_1","PB.PB_CD34_2","PB.PB_CD34_3",
               "PB.PB_BFU_1","PB.PB_BFU_2","PB.PB_BFU_3",
               "PB.PB_CFU_1","PB.PB_CFU_2","PB.PB_CFU_3",
               "PB.Pro_PB_1","PB.Pro_PB_2","PB.Pro_PB_3",
               "PB.Early_baso_PB_1","PB.Early_baso_PB_2","PB.Early_baso_PB_3",
               "R.Late_baso_PB_1","R.Late_baso_PB_2","R.Late_baso_PB_3",
               "R.Poly_PB_1","R.Poly_PB_2","R.Poly_PB_3","R.Orth_PB_1","R.Orth_PB_2","R.Orth_PB_3")
...
pdf(file="../../plots/compare_public_RNAdata_noCB.pdf", width = 3, height = 4)  
